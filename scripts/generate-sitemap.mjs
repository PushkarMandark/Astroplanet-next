...
const STATIC_ROUTES = [
    ...
    { path: "/horoscope/", changefreq: "daily", priority: "0.7" },
    { path: "/panchang/", changefreq: "daily", priority: "0.7" },
    { path: "/numerology/", changefreq: "monthly", priority: "0.6" },
    { path: "/kundli/", changefreq: "monthly", priority: "0.6" },
    { path: "/compatibility/", changefreq: "monthly", priority: "0.6" },
